...
def input_error(func):
    ...
    def inner(*args, **kwargs):
        try:
            ...
            return "Argument not found. Enter real argument for the command please."
    return inner


def parse_input(user_input):
    cmd, *args = user_input.split() # приймає рядок вводу користувача user_input і розбиває його на слова за допомогою методу split() та повертає перше слово як команду cmd та решту як список аргументів *args.
...
def main():
    ...
    while True:
        ...
        if command in ["close", "exit"]:
            ...
            print("Commands: add <name> <phone>, change <username> <new phone>, phone <name>, all, exit (close)")
        elif command == "add":
